...
class Densely_connected_net(Gen_Model):
	...
	def _build_model(self):
		...
		x = Dense(30, activation='relu',kernel_regularizer=regularizers.l2(self.reg_const))(main_input)
		x = Dense(20, activation='relu',kernel_regularizer=regularizers.l2(self.reg_const))(x)
		x = Dense(20, activation='relu',kernel_regularizer=regularizers.l2(self.reg_const))(x)
		x = Dense(15, activation='relu',kernel_regularizer=regularizers.l2(self.reg_const))(x)
...
# class Densely_connected_net_v2(Gen_Model):
# 	def __init__(self, reg_const, learning_rate, input_dim,  output_dim):
# 		Gen_Model.__init__(self, reg_const, learning_rate, input_dim, output_dim)
...
# 		x = self.conv_layer(input_block)

# 		x = Dense(30, activation='linear',kernel_regularizer=regularizers.l2(self.reg_const))(x)
...
# 		x = x = Dense(20, activation='linear',kernel_regularizer=regularizers.l2(self.reg_const))(x)
